 ...
 *
 * Additions must be conventionally gitignored (a committed
 * `.env.example` is already in the worktree), must be fixed by copying
 * alone, and must not grant the agent new capabilities. Two entries were
