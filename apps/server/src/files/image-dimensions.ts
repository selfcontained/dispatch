 ...
 * aspect ratio at render time — which means the ratio has to be on the file
 ...
 * agent startup files, browser-extension screenshots, and stream captures all
 ...
 *
 * Exported because `files/metadata.ts` bounds the stored value by the same
