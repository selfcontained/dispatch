// Whiteboard persistence: one row per agent, optimistic-locked on `version`.
// Shared by the HTTP routes (routes/whiteboard.ts) and the MCP handlers
// (server/mcp-whiteboard-handlers.ts).
