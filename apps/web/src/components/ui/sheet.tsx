...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-white/[0.08] backdrop-blur-2xl p-4 shadow-[0_8px_32px_rgba(0,0,0,0.4),inset_0_1px_0_rgba(255,255,255,0.15)] border-white/[0.18] transition data-[state=closed]:duration-200 data-[state=open]:duration-300 data-[state=open]:animate-in data-[state=closed]:animate-out",
  {
    variants: {
      side: {
