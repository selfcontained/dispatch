    ...
    <div>
      ...
      <div className="flex items-center gap-2">
        <input
          ...
          maxLength={100}
          className={cn(
            "w-full max-w-sm rounded border bg-white/[0.04] px-3 py-1.5 text-sm text-foreground placeholder:text-muted-foreground/50 focus:outline-none disabled:opacity-50",
            saveError ? "border-destructive" : "border-white/[0.12] focus:border-primary/50"
          )}
        />
        {showSaved && !saveError ? (
          ...
          <button
            ...
            className={cn(
              ...
              worktreeLocation === opt.value
                ...
                : "border-white/[0.12] hover:border-muted-foreground/30"
            )}
          >
            ...
            <button
              ...
              className={cn(
                ...
                displayColor === c.id
                  ...
                  : "border-transparent hover:border-muted-foreground/40 hover:bg-white/[0.06]"
              )}
            >
              <img
  ...
  return (
    ...
    >
      <DialogPrimitive.Portal>
        ...
        <DialogPrimitive.Content className="fixed inset-0 md:inset-4 z-[70] flex flex-col overflow-hidden rounded-none md:rounded-sm border border-white/[0.12] bg-white/[0.04] backdrop-blur-xl text-foreground shadow-2xl duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95">
          ...
          <div className="flex min-h-0 flex-1">
            ...
            <nav className="hidden w-48 shrink-0 flex-col border-r border-white/[0.12] py-2 md:flex">
              <div>
              ...
              <div className="mt-auto border-t border-white/[0.12] px-4 pb-3 pt-4">
            ...
            {activeSection === null && (
              <nav className="flex flex-1 flex-col md:hidden">
                ...
                <div className="mt-auto border-t border-white/[0.12] px-5 py-4">
                  <div className="mb-3 text-[10px] font-semibold uppercase tracking-[0.24em] text-muted-foreground">
                    System
                  </div>
