...
import { MediaSidebarContent } from "./media-sidebar";
...
vi.mock("@/components/app/media-content", () => ({
  MediaContent: () => <div data-testid="stub-MediaContent" />,
}));
...
describe("MediaSidebarContent as the drawer", () => {
  it("shows the home tabs with the review in the rail, and its unseen comments", () => {
    renderDrawer("");
    expect(screen.getByTestId("media-sidebar").getAttribute("data-depth")).toBe(
      "0"
    );
