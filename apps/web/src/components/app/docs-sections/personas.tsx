    ...
    <>
      ...
      <Section>
        ...
        <P>
          ...
          review flows. Reviewers also have <Code>whiteboard_get</Code> to read
          their own whiteboard tab — sketch on it to hand the reviewer a diagram
          — though unlike standard agents they cannot draw back.
        </P>
      </Section>
