    ...
    >
      <DialogPrimitive.Portal>
        ...
        <DialogPrimitive.Content
          ...
          className="fixed inset-0 z-[70] flex flex-col overflow-hidden border border-white/[0.2] bg-white/[0.08] backdrop-blur-2xl text-foreground shadow-[0_16px_64px_rgba(0,0,0,0.5),inset_0_1px_0_rgba(255,255,255,0.15)] duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 md:inset-4 md:rounded-sm"
        >
