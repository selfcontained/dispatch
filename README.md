...
- Browser UI with:
  ...
  - iOS Simulator screenshot capture via the `dispatch_share` MCP tool (macOS only)
...
| `dispatch_share` | Upload screenshots, media, and text snippets to the agent's media pane |
